...
- 於 Python 爬蟲端與 SQL 端結合 BEGIN TRANSACTION 與 WITH (UPDLOCK, SERIALIZABLE) 排他鎖，徹底解決多執行緒批次寫入時的 Deadlock 問題，確保 ACID 特性。
...
- 01_DDL_Tables.sql: 基礎資料表建置 (Tables, PK/FK, Default Constraints)
- 02_DQL_Views.sql: 商業智慧檢視表 (BI Fact/Dim Views, 異常監控視圖)
- 03_DML_StoredProcedures.sql: ETL 處理、資料清洗與品質監控預存程序
